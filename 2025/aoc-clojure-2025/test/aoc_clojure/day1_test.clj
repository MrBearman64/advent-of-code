...
(deftest example-test-functional-part2
  (testing "Day 1 - Part 2"
    (is (= (solve-day1-part2-functional 50 rotations) 6))))
...
(deftest day1-file-test-part2
  (testing "Day 1 - Part 2 - File Input"
    (let [input (seq (read-challenge-input))]
      (is ((complement zero?) (solve-day1-part2-functional 50 input))))))
